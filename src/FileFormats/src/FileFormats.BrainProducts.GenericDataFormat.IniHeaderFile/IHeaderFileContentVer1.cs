...
public interface IHeaderFileContentVer1
{
    ...
    DataType DefaultDataType => HeaderFileEnums.DataType.TIMEDOMAIN;
    bool DefaultAveraged => false;
    BinaryFormat DefaultBinaryFormat => HeaderFileEnums.BinaryFormat.INT_16;
    SegmentationType DefaultSegmentationType => HeaderFileEnums.SegmentationType.NOTSEGMENTED;
    ...
    /// Mandatory
    /// </summary>
    IList<ChannelInfo>? GetChannelInfos();
    /// <summary>
    /// Mandatory
    /// </summary>
    void SetChannelInfos(IList<ChannelInfo>? channelInfos);
    #endregion
    ...
    /// </summary>
    IList<Coordinates>? GetChannelCoordinates();
    /// <summary>
    /// Optional
    /// A dictionary key is 0-indexed channel number
    /// </summary>
    void SetChannelCoordinates(IList<Coordinates>? channelCoordinates);
    #endregion
