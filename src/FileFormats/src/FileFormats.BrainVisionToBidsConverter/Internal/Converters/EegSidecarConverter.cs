...
internal static class EegSidecarConverter
{
    public static EegSidecar Collect(BrainVisionPackage filesContent, CustomizationInfo info, string actualTaskName)
    {
        ...
        IList<ChannelInfo>? channelInfos = headerContent.GetChannelInfos();

        EegSidecar sidecar = new(
            //REQUIRED Generic
            actualTaskName,
            ...
            Defs.NotAvailable)
        {
            ...
            //RecordingDuration = 0,
            RecordingType = headerContent.Averaged!.Value ? RecordingType.epoched : RecordingType.continuous,
