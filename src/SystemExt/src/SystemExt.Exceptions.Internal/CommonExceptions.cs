...
{
    /// <summary>
    /// This exception shall be created in scenarios in which the operation is always invalid during the whole object's lifetime. 
    ...
    public static NotSupportedException CreateNotSupported(string message, [CallerMemberName] string? methodName = null)
        => new(ExceptionMessages.GetNotSupportedMessage(message, methodName!));

    /// <summary>
    /// This exception shall be created in scenarios in which it is generally sometimes possible for the object to perform
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static InvalidOperationException CreateInvalidOperation(string message, [CallerMemberName] string? methodName = null)
        => new(ExceptionMessages.GetInvalidOperationMessage(message, methodName!));
    ...
    public static void ThrowNotSupported(string message, [CallerMemberName] string? methodName = null)
        => throw CreateNotSupported(message, methodName);
    ...
    public static void ThrowInvalidOperation(string message, [CallerMemberName] string? methodName = null)
        => throw CreateInvalidOperation(message, methodName);
}
