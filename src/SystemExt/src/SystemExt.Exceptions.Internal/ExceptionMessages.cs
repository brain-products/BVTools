...
internal static class ExceptionMessages
{
    ...
    public const string ArgumentMonotonyMessage = "Specified argument does not satisfy monotony requirements.";
    public const string ArgumentContainsDuplicatesMessage = "Specified argument does not satisfy uniqueness requirements.";
    ...
    #region Monotony Check Messages

    public static string GetIsStrictlyMonotonicIncreasingMessage(string name)
        => Invariant($"{ArgumentMonotonyMessage} The entries of {GetParamString(name)} are not strictly monotonic increasing.");

    public static string GetMonotonicIncreasingMessage(string name)
        => Invariant($"{ArgumentMonotonyMessage} The entries of {GetParamString(name)} are not monotonic increasing.");

    public static string GetDuplicatesMessage(string name)
        => Invariant($"{ArgumentContainsDuplicatesMessage} Some entries of {GetParamString(name)} occur more than once.");
    #endregion
